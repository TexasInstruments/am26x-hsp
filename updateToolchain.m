function out = updateToolchain(hObj)
...
%   Detailed explanation goes here
	...
	if(strcmp(out,'FreeRTOS'))
		...
		set_param(cs,'Toolchain','TI ARM Clang Compiler AM263x FreeRTOS | gmake');
	else
		%set the Baremetal toolchain
		set_param(cs,'Toolchain','TI ARM Clang Compiler AM263X | gmake');
	end
end
