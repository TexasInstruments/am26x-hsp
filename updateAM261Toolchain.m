function out = updateAM261Toolchain(hObj)
...
%   Detailed explanation goes here
	...
	if(strcmp(out,'FreeRTOS'))
		...
		set_param(cs,'Toolchain','TI ARM Clang Compiler AM261x FreeRTOS | gmake');
	else
		%set the Baremetal toolchain
		set_param(cs,'Toolchain','TI ARM Clang Compiler AM261x | gmake');
	end
end
