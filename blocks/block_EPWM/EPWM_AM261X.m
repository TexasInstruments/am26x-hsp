...
classdef EPWM_AM261X < matlab.System & coder.ExternalDependency
    %
    ...
    properties(Constant,Hidden)
        ePWMModuleSet = matlab.system.StringSet({'EPWM0', 'EPWM1', 'EPWM2', 'EPWM3', 'EPWM4', 'EPWM5', 'EPWM6', 'EPWM7', 'EPWM8', 'EPWM9'});
        ...
        SyncInPulseSrcSet = matlab.system.StringSet({'Disable Sync-in', 'Sync-in source is EPWM0 sync-out signal', 'Sync-in source is EPWM1 sync-out signal', 'Sync-in source is EPWM2 sync-out signal', 'Sync-in source is EPWM3 sync-out signal', 'Sync-in source is EPWM4 sync-out signal', 'Sync-in source is EPWM5 sync-out signal', 'Sync-in source is EPWM6 sync-out signal', 'Sync-in source is EPWM7 sync-out signal', 'Sync-in source is EPWM8 sync-out signal', 'Sync-in source is EPWM9 sync-out signal', 'Sync-in source is ECAP0 sync-out signal', 'Sync-in source is ECAP1 sync-out signal', 'Sync-in source is ECAP2 sync-out signal', 'Sync-in source is ECAP3 sync-out signal', 'Sync-in source is ECAP4 sync-out signal', 'Sync-in source is ECAP5 sync-out signal', 'Sync-in source is ECAP6 sync-out signal', 'Sync-in source is ECAP7 sync-out signal', 'Sync-in source is Input XBAR Out4 signal', 'Sync-in source is Input XBAR Out20 signal', 'Sync-in source is C2K Timesync XBAR PWM Output 0 signal', 'Sync-in source is C2K Timesync XBAR PWM Output 1 signal', 'Sync-in source is FSIRX0 Trigger0 signal', 'Sync-in source is FSIRX0 Trigger1 signal', 'Sync-in source is FSIRX0 Trigger2 signal', 'Sync-in source is FSIRX0 Trigger3 signal'});
        ...
        ePWMLinkCMPCSet = matlab.system.StringSet({'Link with ePWM0', 'Link with ePWM1', 'Link with ePWM2', 'Link with ePWM3', 'Link with ePWM4', 'Link with ePWM5', 'Link with ePWM6', 'Link with ePWM7', 'Link with ePWM8', 'Link with ePWM9'});
    ...
    methods
        % Constructor
        function obj = EPWM_AM261X(varargin)
