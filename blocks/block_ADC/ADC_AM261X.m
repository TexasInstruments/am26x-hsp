...
classdef ADC_AM261X < matlab.System & ...
   ...
   properties(Constant,Hidden)
        ADCModuleSet = matlab.system.StringSet({'ADC0', 'ADC1', 'ADC2'});
        ...
        ChannelsSet = matlab.system.StringSet({'Channel 0', 'Channel 1', 'Channel 2', 'Channel 3', 'Channel 4', 'Channel 5', 'Channel CAL0', 'Channel CAL1'});
        Channels1Set = matlab.system.StringSet({'Channels 0 and 1', 'Channels 1 and 0', 'Channels 2 and 3', 'Channels 3 and 2', 'Channels 4 and 5', 'Channels 5 and 4', 'Channel CAL0 CAL1'});
   ...
   properties (Dependent, Access=protected)
    ...
    methods
        % Constructor
        function obj = ADC_AM261X(varargin)
        ...
        function ret = get.SOCxTriggerSourceEnum(obj)
            ...
            elseif isequal(obj.SOCxTriggerSource, 'ECAP9 SOCEVT')
                ret = 0X51;
            elseif isequal(obj.SOCxTriggerSource, 'ECAP10 SOCEVT')
                ret = 0X52;
            elseif isequal(obj.SOCxTriggerSource, 'ECAP11 SOCEVT')
                ret = 0X53;
            elseif isequal(obj.SOCxTriggerSource, 'ECAP12 SOCEVT')
                ret = 0X54;
            elseif isequal(obj.SOCxTriggerSource, 'ECAP13 SOCEVT')
                ret = 0X55;
            elseif isequal(obj.SOCxTriggerSource, 'ECAP14 SOCEVT')
                ret = 0X56;
            elseif isequal(obj.SOCxTriggerSource, 'ECAP15 SOCEVT')
                ret = 0X57;
            elseif isequal(obj.SOCxTriggerSource,'RTI Timer4')
                ret = 0X58;
            elseif isequal(obj.SOCxTriggerSource,'RTI Timer5')
                ret = 0X59;
            elseif isequal(obj.SOCxTriggerSource,'RTI Timer6')
                ret = 0X5A;
            elseif isequal(obj.SOCxTriggerSource,'RTI Timer7')
                ret = 0X5B;
            elseif isequal(obj.SOCxTriggerSource,'Repeater 0')
                ret = 0X7E;
            elseif isequal(obj.SOCxTriggerSource,'Repeater 1')
                ret = 0X7F;
            else
                ret = 0X00;
            end
       ...
       function ret = get.INTWillTriggerSOCxEnum(obj)
        ...
        function ret = get.BurstModeTriggerEnum(obj)
            ...
            elseif isequal(obj.BurstModeTrigger, 'ECAP9 SOCEVT')
                ret = 0X51;
            elseif isequal(obj.BurstModeTrigger, 'ECAP10 SOCEVT')
                ret = 0X52;
            elseif isequal(obj.BurstModeTrigger, 'ECAP11 SOCEVT')
                ret = 0X53;
            elseif isequal(obj.BurstModeTrigger, 'ECAP12 SOCEVT')
                ret = 0X54;
            elseif isequal(obj.BurstModeTrigger, 'ECAP13 SOCEVT')
                ret = 0X55;
            elseif isequal(obj.BurstModeTrigger, 'ECAP14 SOCEVT')
                ret = 0X56;
            elseif isequal(obj.BurstModeTrigger, 'ECAP15 SOCEVT')
                ret = 0X57;
            elseif isequal(obj.BurstModeTrigger,'RTI Timer4')
                ret = 0X58;
            elseif isequal(obj.BurstModeTrigger,'RTI Timer5')
                ret = 0X59;
            elseif isequal(obj.BurstModeTrigger,'RTI Timer6')
                ret = 0X5A;
            elseif isequal(obj.BurstModeTrigger,'RTI Timer7')
                ret = 0X5B;
            elseif isequal(obj.BurstModeTrigger,'Repeater 0')
                ret = 0X7E;
            elseif isequal(obj.BurstModeTrigger,'Repeater 1')
                ret = 0X7F;
            else
                ret = 0X00;
            end
