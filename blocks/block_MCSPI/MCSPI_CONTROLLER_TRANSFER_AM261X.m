...
classdef MCSPI_CONTROLLER_TRANSFER_AM261X  < matlab.System & ...
    ...
    properties (Constant, Hidden)
        MCSPI_InstanceSet = matlab.system.StringSet({'MCSPI0', 'MCSPI1', 'MCSPI2', 'MCSPI3'});
    end
    ...
    methods
        % Constructor
        function obj = MCSPI_CONTROLLER_TRANSFER_AM261X(varargin)
