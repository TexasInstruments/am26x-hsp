...
classdef MCSPI_WRITE_AM263X < matlab.System & ...
    ...
    methods
        % Constructor
        function obj = MCSPI_WRITE_AM263X(varargin)
    ...
    methods (Static, Access=protected)
        ...
        function header = getHeaderImpl()
            header = matlab.system.display.Header(...
                'Title','MCSPI_WRITE',...
                'Text', sprintf('%s\n%s','Configure the MCSPI Write block'),...
        ...
        function groups = getPropertyGroupsImpl
            ...
            General = matlab.system.display.SectionGroup(...
             'Title', 'General', ...
             "PropertyList", {'MCSPI_Instance', 'Enable_Channel0', 'Enable_Channel1'});
    ...
    methods (Access=protected)
        function setupImpl(obj) %#ok<MANU>
            if isempty(coder.target)
                ...
                coder.cinclude('MW_MCSPIWRITE.h');
        ...
        function status = stepImpl(obj, u)  %#ok<INUSD>
            if isempty(coder.target)
                ...
                mcspi_write_step_struct = struct('base', obj.baseaddr, 'mcspi_instance', obj.MCSPI_InstanceEnum,'Enable_CH0', obj.Enable_Channel0, 'Enable_CH1', obj.Enable_Channel1, 'CH0_DataSize', obj.Channel0_Data_Size, 'CH1_DataSize', obj.Channel1_Data_Size, 'CH0_CSDisable', obj.Channel0_Auto_CSDeassert, 'CH1_CSDisable', obj.Channel1_Auto_CSDeassert, 'dataType', obj.DataType);
                coder.cstructname(mcspi_write_step_struct, 'MCSPIWriteStepStruct', 'extern', 'HeaderFile', 'MW_MCSPIWRITE.h');
                coder.ceval('MCSPIWRITE_step', coder.ref(mcspi_write_step_struct), uint32(InputLen), coder.ref(u));
            end
        end
        ...
        function releaseImpl(obj) %#ok<MANU>
            if isempty(coder.target)
                ...
                coder.ceval('MCSPIWRITE_release');
            end
        end
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, context)
            if context.isCodeGenTarget('rtw')
                ...
                addIncludeFiles(buildInfo, 'MW_MCSPIWRITE.h', includeDir);
                addSourceFiles(buildInfo, 'MW_MCSPIWRITE.c', srcDir);
