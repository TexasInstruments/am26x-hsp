...
setupFile_Dir = strrep(this_dir, '+matlabshared\+target\+am26x\+am263x', 'toolchain\am263x\+matlabshared\+toolchain\+ti_arm_clang');
...
ccxmlPath = [thisFilePath '/AM263x.ccxml']
